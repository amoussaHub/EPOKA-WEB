window.onload = function() {
    ...
    document.getElementById("user").innerHTML = "utilisateur n°" + user + " connecté";
    document.getElementById("id").setAttribute("value", user);

}

document.addEventListener("DOMContentLoaded", () => {
    const Connexion = document.getElementById("deconnexion");
